              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('My Area: ${widget.destinationPoint.yourArea}', style: TextStyle(fontSize: 17)),
                    Text('Detail Address: ${widget.destinationPoint.detailAddress}', style: TextStyle(fontSize: 17)),
                  ],
                ),
              ),
              Padding(
